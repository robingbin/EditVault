...
const variants = {
  // Editor statuses
  'Not Started': "bg-[#1a2526] text-[#8aa0a1] border-[#243334]",
  'WIP': "bg-amber-500/10 text-amber-300 border-amber-500/30",
  'Sent To Client': "bg-violet-500/10 text-violet-300 border-violet-500/30",
  'Corrections Updated': "bg-cyan-500/10 text-cyan-300 border-cyan-500/30",
  // Client statuses
  'Pending Review': "bg-blue-500/10 text-blue-300 border-blue-500/30",
